...
class Day18Test {
	...
	@Test void testPart2() {
		var dataTest = DataReader.readAlchemyString(resourcePath.resolve("day18test.txt"));
		assertEquals(3993, new Day18().part2(dataTest));
	}
}